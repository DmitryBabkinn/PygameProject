...
class MinesweeperMap():
    ...
    def update(self, mouse_pressed=None, mouse_pos=None, type_='down'):
        ...
        if self.mouse_pos[0] < self.cfg.BORDERSIZE or self.mouse_pos[0] > self.cfg.SCREENSIZE[
            0] - self.cfg.BORDERSIZE or \
                self.mouse_pos[1] < self.cfg.GRIDSIZE * 2 or self.mouse_pos[1] > self.cfg.SCREENSIZE[
            1] - self.cfg.BORDERSIZE:
            return
